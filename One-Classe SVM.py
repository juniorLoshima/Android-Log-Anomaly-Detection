...
# Appliquer l'algorithme One-Class SVM pour la détection d'anomalies
ocsvm = OneClassSVM(kernel='rbf', gamma='auto', nu=0.05)
logs_df['anomaly_score'] = ocsvm.fit_predict(X_scaled)

# One-Class SVM attribue -1 aux points considérés comme des anomalies
...
plt.title("Detection des anomalies dans les logs Android avec One-Class SVM")
...
anomalies.to_csv('ocsvm_anomalies_report.csv', index=False)
